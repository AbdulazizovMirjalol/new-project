...
#     price_text = price_location.lower()
#     rsi_lower = rsi_text.lower()
#     macd_lower = macd_text.lower()

#     # BUY side
#     if "bullish" in h1_trend.lower():
#         if (
#             "bullish" in m15_trend.lower()
#             and ("support" in price_text or "entry" in entry_text or "ema20" in entry_text)
#         ):
#             if (
#                 "bullish" in candle_text
#                 and "bullish" in rsi_lower
#                 and "bullish" in macd_lower
#             ):
#                 return "READY BUY"

#             if (
#                 "bullish" in rsi_lower
#                 or "bullish" in macd_lower
#                 or "support" in price_text
#                 or "ema20" in entry_text
#             ):
#                 return "BUY WATCH"

#     # SELL side
#     if "bearish" in h1_trend.lower():
#         if (
#             "bearish" in m15_trend.lower()
#             and ("resistance" in price_text or "entry" in entry_text or "ema20" in entry_text)
#         ):
#             if (
#                 "bearish" in candle_text
#                 and "bearish" in rsi_lower
#                 and "bearish" in macd_lower
#             ):
#                 return "READY SELL"

#             if (
#                 "bearish" in rsi_lower
#                 or "bearish" in macd_lower
#                 or "resistance" in price_text
#                 or "ema20" in entry_text
#             ):
#                 return "SELL WATCH"
...
# ):
#     if (
#         suggested_entry is None
#         or suggested_sl is None
#         or suggested_tp is None
#     ):
#         return None
...
#     bullish_candle_ok = "bullish" in candle_confirmation.lower()
#     bearish_candle_ok = "bearish" in candle_confirmation.lower()

#     if setup_status == "READY BUY":
#         if signal_strength in ["MEDIUM", "STRONG"] and bullish_candle_ok and rr_ok:
#             return "BUY"

#     if setup_status == "READY SELL":
#         if signal_strength in ["MEDIUM", "STRONG"] and bearish_candle_ok and rr_ok:
#             return "SELL"
...
# ):
#     if setup_status == STATUS_READY_BUY:
#         return round(max(current_price, ema20_value), 2)

#     elif setup_status == STATUS_READY_SELL:
#         return round(min(current_price, ema20_value), 2)
